...
int verifCasesAdjacentes(int** tab, int nb_ligne, int nb_colone, int ligne, int colone, int torique){
	...
	if (torique){
		if (ligne == 0 && colone == 0) nbCasesAdjPleines = tab[0][1] +	tab[1][0] +	tab[1][1] +	tab[0][nb_colone-1] + tab[1][nb_colone-1] +	tab[nb_ligne-1][0] + tab[nb_ligne-1][1] + tab[nb_ligne-1][nb_colone-1];																		//verif si on est en haut à gauche
		else{
